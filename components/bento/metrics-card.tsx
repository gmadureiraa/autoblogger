  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col justify-center gap-6 p-6">
        <ScrambleNumber target="94/100" label="SEO Score medio" delay={500} />
        <ScrambleNumber target="365" label="Artigos / ano (1/dia)" delay={800} />
        <ScrambleNumber target="48h" label="Setup completo" delay={1100} />
        <ScrambleNumber target="R$15" label="Custo API / mes (1/dia)" delay={1400} />
      </div>
    </div>
  )
}
